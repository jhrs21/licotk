...
<div id="top" class="white-frame" style="margin-left: 15px">
...
<div class="analytics-content span-24">
    <div class="analytics-text span-24">
        ...
        <div class="feedback-area span-10 last">
            ...
            <div class="main-canvas-content-footer"><a href="<?php echo url_for('feedbackAffiliate', array("affiliate_id" => $affiliate->getId())) ?>">Todos los comentarios</a></div>
            <?php if ($assets->count() > 1): ?>
                <div class="white-frame barside">
                    ...
                    <?php foreach ($assets as $asset): ?>
                        <?php echo link_to($asset, 'analyticsAsset', array('affiliate_id' => $affiliate->getId(),'asset_id' => $asset->getId())) ?><br>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="analytics-charts span-24">
        ...
        <?php
            ...
            $xChart->render();
            ?>
            <div id="ColumnChartX" class="span-24 last"></div>
    </div>
</div>
