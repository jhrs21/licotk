...
<div class="main-container-inner">
    ...
    <div id="analytics-container" class="main-canvas">
        ...
        <div id="top" class="white-frame" style="display: none;">
            <form action="<?php echo url_for('@analytics_asset_post?alpha_id='.$asset->getAlphaId())?>" method="post">
                <div id="date-filter">
                    <?php echo $form ?>
                    <input id="filter-button" type="submit" value="Filtrar" />
                    <a href="<?php echo url_for('@analytics_asset?alpha_id='.$asset->getAlphaId())?>">Reiniciar</a>
                </div>
            </form>
        </div>
        <div id="left" class="white-frame">
            <div class="analytics-header">
                <div class="analytics-title-full">
                    <p><?php echo __('Estadísticas para').': <b>'.$asset.'</b>' ?></p>
                </div>
            </div>
            <div class="analytics-header">
        ...
        <div id="right">
            <div class="feedback-area white-frame barside">
                ...
                <div class="main-canvas-content-footer">
                    <a href="<?php echo url_for('all_asset_feedbacks',$asset) ?>">Todos los comentarios para <?php echo $asset?></a>
                </div>
            </div>
            <?php if($assets->count() > 1): ?>
                <div class="white-frame barside">
                    ...
                    <?php endforeach; ?>
                    <div class="main-canvas-content-footer">
                        <a href="<?php echo url_for('analytics') ?>">Estadísticas globales</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
