                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td width="3"></td>
                                                            <td valign="middle">
                                                                <div class="header-content" style="width: 56px;"><a href="http://www.facebook.com/lealtag">Me gusta</a></div>
                                                            </td>
                                                            ...
                                                            <td valign="middle">
                                                                <div class="header-content">
                                                                    <a href="http://www.twitter.com/lealtag">Síguenos</a>
                                                                </div>
                                                            </td>
                                                            <td class="w10" width="10"></td>
                                                            <td valign="middle">
                                                                    ...
                                                                    <td class="w580" width="580">
                                                                        ...
                                                                        <div align="left" class="article-content">
                                                                            <multiline label="Description">
                                                                                <p>
                                                                                    <h2>¡Felicitaciones %FULLNAME%, acabas de canjear un Premio en %ASSET%!</h2>
                                                                                </p>
                                                                                <p>
