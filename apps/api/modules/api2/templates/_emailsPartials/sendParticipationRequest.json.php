                                                            ...
                                                            <tr>
                                                                <td class="w580" width="580">
                                                                    <h1 align="left" class="article-title">
                                                                        <singleline label="Title">%FULLNAME%,</singleline>
                                                                    </h1>
                                                                    <div align="left" class="article-content">
                                                                        <multiline label="Description">
                                                                            <p>
                                                                                Si pagaste tu consumo en <b>%ASSET%</b> con tu tarjeta Maestro o Mastercard, <b>participa por una 
                                                                                de las dos tarjetas pre-pagadas MasterCard de Bs.2500</b> que rifaremos cada mes, ingresa <a href="%URL%"><b>AQUÍ</b></a> 
                                                                                o copia el siguiente link en la barra de direcciones de tu explorador:
                                                                                </h2>
                                                                                <br>
                                                                                <a href="%URL%">%URL%</a>
                                                                            </p>
                                                                            <p>
                                                                                <b>Recuerda guardar el comprobante de pago</b>, 
                                                                                ya que lo necesitarás en caso que resultes ganador en esta 
