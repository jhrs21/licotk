...
<?php echo __(<<<EOM
    ¡Felicitaciones %FULLNAME%, hemos validado tu cuenta LealTag!
    ...
    nuestra página web LealTag.com para acceder a tu cuenta, ver tus
    premios e imprimir tu tarjeta LealTag.

    Con tu cuenta de LealTag también puedes ingresar a TuDescuentón.com
    y conseguir los mejores descuentos de tu ciudad. Utiliza el mismo correo electrónico y contraseña 
    al momento de ingresar en TuDescuentón.com y gana tags por comprar cupones y ahorrar.
