                                                                ...
                                                                <tr>
                                                                    <td class="w580" width="580">
                                                                        <h1 align="left" class="article-title">
                                                                            <singleline label="Title">¡Felicitaciones has recibido %TAGS_QUANTITY%!</singleline>
                                                                        </h1>
                                                                        <div align="left" class="article-content">
                                                                            <multiline label="Description">
                                                                                <p>
                                                                                    <h2>%FULLNAME%, acabas de recibir %TAGS_QUANTITY% en %ASSET%</h2>
                                                                                </p>
                                                                                <p>
...
, array(
    ...
    "%ASSET%" => $asset,
    "%FEEDBACK%" => $feedback,
    "%TAGS_QUANTITY%" => ($tags > 1 ? $tags.' Tags' : 'un Tag')
))
?>
