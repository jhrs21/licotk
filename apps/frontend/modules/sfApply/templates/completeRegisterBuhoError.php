...
<?php $body = 'Hay un problema al intentar completar el registro con mi email "'.$email.'". La respuesta del sistema ha sido: Error '.$error['code'].', Mensaje: '.$error['message'].' '; ?>
    ...
    <div class="main-canvas box_round gray-background">
        <div class="main-canvas">
            ...
            <div class="error-content">
                <p>
                    Hubo un inconveniente al momento de completar tu registro y verificar tu email.
                </p>
                <p>
                    Por favor, contactanos en la siguiente dirección de correo 
                    <b class="darkblue">
                        <a target="_blank" href="mailto:soporte@lealtag.com?subject=<?php echo urlencode('Error al completar registro - ErrorBuho ') ?>&body=<?php echo urlencode($body) ?>">
                            soporte@lealtag.com
                        </a>
                    </b>
                </p>
