...
<?php $body = 'Hay un problema al confirmar mi email'.(isset($email) ?  ' "'.$email.'"' : '').'. La respuesta del sistema ha sido: Error '.$error['code'].', Mensaje: '.$error['message']; ?>
        ...
        <div class="main-canvas">
            ...
            <div class="error-content">
                ...
                <p>
                    ...
                    <b class="darkblue">
                        <a target="_blank" href="mailto:soporte@lealtag.com?subject=<?php echo urlencode('Error al confirmar cuenta - ErrorBuho ') ?>&body=<?php echo urlencode($body) ?>">
                            soporte@lealtag.com
                        </a>
                    </b>
                </p>
