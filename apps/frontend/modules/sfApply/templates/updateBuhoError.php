...
<?php $body = 'Hay un problema al intentar actualizar mi cuenta, mi email es "'.$email.'" La respuesta del sistema ha sido: Error '.$error['code'].', Mensaje: '.$error['message'].' '; ?>
    ...
    <div class="main-canvas box_round gray-background">
        <div class="main-canvas">
            ...
            <div class="error-content">
                <p>
                    Hubo un inconveniente al momento de intentar actualizar tus datos.
                </p>
                <p>
                    Por favor, contactanos en la siguiente dirección de correo 
                    <b class="darkblue">
                        <a target="_blank" href="mailto:soporte@lealtag.com?subject=<?php echo urlencode('Error al actualizar datos - ErrorBuho ') ?>&body=<?php echo urlencode($body) ?>">
                            soporte@lealtag.com
                        </a>
                    </b>
                </p>
