...
<?php $body = 'Hay un problema al hacer una petición para modificar mi contraseña, mi email es "'.$email.'". La respuesta del sistema ha sido: Error '.$error['code'].', Mensaje: '.$error['message']; ?>
    ...
    <div class="main-canvas box_round gray-background">
        <div class="main-canvas">
            ...
            <div class="error-content">
                <p>Hubo un inconveniente en la solicitud de modificación de contraseña.</p>
                <p>
                    Por favor, contactanos en la siguiente dirección de correo 
                    <b class="darkblue">
                        <a target="_blank" href="mailto:soporte@lealtag.com?subject=<?php echo urlencode('Error en la petición de modificación de contraseña - ErrorBuho ') ?>&body=<?php echo urlencode($body) ?>">
                            soporte@lealtag.com
                        </a>
                    </b>
                </p>
