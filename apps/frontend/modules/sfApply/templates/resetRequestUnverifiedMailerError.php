    ...
    <div class="main-canvas box_round gray-background">
        <div class="main-canvas">
            ...
            <div class="error-content">
                <p>Ha ocurrido un inconveniente al intentar enviar el correo de verificación de tu cuenta.</p>
                <p>
                    Por favor, vuelve a intentarlo haciendo clic 
                    <b class="darkblue"><?php echo link_to('AQUÍ', url_for('sf_guard_forgot_password'))?></b>.
                </p>
                <br>
