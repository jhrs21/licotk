                                                ...
                                                <layout label="Text only">
                                                    <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td class="w580" width="580">
                                                                    <h1 align="left" style="color:#006bb5;text-shadow:1px 1px 2px #888888;filter:dropshadow(color=#888888, offx=1, offy=1);">
                                                                        <singleline label="Title">¡Completa tu registro y disfruta tus premios!</singleline>
                                                                    </h1>
                                                                    <div align="left" class="article-content">
                                                                        <multiline label="Description">
                                                                            <p>
                                                                                Para comenzar a disfrutar todos los premios que tus comercios favoritos ofrecen para ti a través de 
                                                                                LealTag, completa tu registro haciendo clic en este <b><a style="color:#009ddf" href="https://www.lealtag.com/usuario/completar/registro?v=%VALIDATOR%">LINK</a></b>:
                                                                            </p>
                                                                            <br>
                                                                            <p align="center">
                                                                                <a style="width:auto;padding:5px 10px;color:#ffffff;font-size:1.25em;
                                                                                   text-transform:uppercase;text-decoration:none;cursor:pointer;
                                                                                   border:3px #fff solid;-webkit-box-shadow:3px 3px 3px #aaa;
                                                                                   -moz-box-shadow:3px 3px 3px #aaa;box-shadow:3px 3px 3px #aaa;
                                                                                   ...
                                                                                   background-clip:padding-box;background:#006bb5;" 
                                                                                   href="https://www.lealtag.com/usuario/completar/registro?v=%VALIDATOR%" target="_blank">
                                                                                    Completar Registro
                                                                                </a>
                                                                            </p>
                                                                            <br>
                                                                            <p>
                                                                                ...
                                                                                haciendo clic <a style="color:#009ddf" href="http://www.lealtag.com/descarga">AQUÍ</a>.
                                                                            </p>

                                                                            <p>
                                                                                Si no tienes uno de estos equipos, pide una tarjeta LealTag en un comercio afiliado o imprímela  
                                                                                <a style="color:#009ddf" href="https://www.lealtag.com/usuario/tarjeta">AQUÍ</a>
                                                                            </p>
                                                                            <p>
                    ...
                    <tr>
                        <td class="w640" width="640">
                            <table id="footer" class="w640" width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#585D61">
                                <tbody>
                                    <tr>
                                        <td class="w30" width="30"></td><td class="w580 h0" width="360" height="30"></td><td class="w0" width="60"></td>
                                        <td class="w0" width="160"></td><td class="w30" width="30"></td>
                                    </tr>
                                    <tr>
                                        <td class="w30" width="30"></td>
                                        <td class="w580" width="720" valign="top">
                                            ...
                                            <p align="center" class="footer-content-left" style="color:white;">Dirección: Av. Neverí, Quinta Mireille, Colinas de Bello Monte, Caracas - Venezuela.</p>
                                            <p align="center" class="footer-content-left" style="color:white;">Recibió este correo porque usted está registrado en LealTag</p>
                                        </td>
