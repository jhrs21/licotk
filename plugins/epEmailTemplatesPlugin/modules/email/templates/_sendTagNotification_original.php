...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html>
    <head><title>TITULO</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
                                                            ...
                                                            <tr>
                                                                <td class="w580" width="580">
                                                                    <h1 align="left" class="article-title">
                                                                        <singleline label="Title">¡Felicitaciones %FULLNAME%, acabas de recibir un Tag en %ASSET%!</singleline>
                                                                    </h1>
                                                                    <div align="left" class="article-content">
                                                                        <multiline label="Description">
                                                                            <p>
                                                                            <h2>Cuéntale a %ASSET% que tal ha sido tu experiencia al visitarlos y gana puntos LealTag haciendo
                                                                                clic <a href="%ROUTE%">aquí</a>.</h2>
                                                                            </p>
                                                                            <p>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                iPhone o Android desde el siguiente <a href="www.lealtag.com/descarga">link</a> o en la tienda de aplicaciones. Si no tienes 
