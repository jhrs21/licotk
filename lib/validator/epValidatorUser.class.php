 ...
 */
class epValidatorUser extends sfGuardValidatorUser {
    ...
    public function configure($options = array(), $messages = array()) {
        ...
        $this->addMessage(
                'not_active', 'Aún no has confirmado tu correo electrónico.' .
                '<br>Haz click <a href="%URL%">Aquí</a> y te enviaremos un correo con el link de confimación.'
        );
    }
                ...
                if (!$user->getIsActive()) {
                    ...
                    if ($type && strcasecmp($type, 'New') == 0) {
                        ...
                        $url = $routing->generate(
                                'resend_verification', array('user_alpha' => $user->getAlphaId()), true
                        );
